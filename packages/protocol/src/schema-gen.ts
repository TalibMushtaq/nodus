...
const entries: SchemaEntry[] = [
  ...
  { name: "presence_query", schema: PresenceQueryPayloadSchema.toJSONSchema() },
  { name: "presence_result", schema: PresenceResultPayloadSchema.toJSONSchema() },
  ...
  { name: "node_shard_fetch", schema: NodeShardFetchPayloadSchema.toJSONSchema() },
  // Data-channel download frames (device ↔ node). Not WS-envelope messages,
  // but part of the wire contract the Rust node mirrors.
  { name: "shard_fetch_request", schema: ShardFetchRequestPayloadSchema.toJSONSchema() },
  { name: "shard_data_header", schema: ShardDataHeaderSchema.toJSONSchema() },
  ...
  { name: "catalog_changed", schema: CatalogChangedPayloadSchema.toJSONSchema() },
