...
| [`phase18-review.md`](./phase18-review.md) | Static review confirming the Relay never sees plaintext keys/shards and that device revocation removes envelope access without full key rotation (Phase 18). |
